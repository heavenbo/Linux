...
- 1.`Exec=/usr/bin/google-chrome-stable%U` change to `Exec=/usr/bin/google-chrome-stable --proxy-server="socks://localhost:7890"%U`
- 2. sudo update-desktop-database /usr/share/applications
- 3. nautilus -q
